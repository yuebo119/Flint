...
<p align="left">
  <strong>🔥 .NET 10 打造的高性能静态站点生成器 · 万页构建 3.4 秒 · 增量 43ms · NativeAOT 单文件 · 内存占用随规模稳定</strong>
</p>

<p align="left">
实测能力：10,007 页站点冷构建 3.4 秒、内存峰值 367MB；14,576 页技术文档站点 5.4 秒；
千页复杂主题（多层嵌套模板 + 全站循环）0.5~1.6 秒，构建时间随页数与主题复杂度线性扩展。
Markdown 解析 188k 文件/秒，模板渲染 49.6k 页/秒，增量改动 43ms 完成。
